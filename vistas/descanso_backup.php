    ...
    <form  action="" class="lockscreen-credentials" name="formulario" id="formulario" method="POST">
      <div class="input-group">
        ...
        <div class="input-group-btn">
          <button type="button" class="btn btn-primary"><i class="fa fa-list text-muted">Entrada</i></button>
          <button type="button" class="btn btn-warning"><i class="fa fa-child text-muted"> Inicio Break</i></button>
          <button type="button" class="btn btn-success"><i class="fa fa-glass text-muted">Final Break</i></button>
          <button type="button" class="btn btn-danger"><i class="fa fa-close text-muted">Salida</i></button>
        </div>
      </div>
    </form>
