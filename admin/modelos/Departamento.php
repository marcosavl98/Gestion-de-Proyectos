...
public function insertar($nombre,$descripcion,$idusuario){
	...
	$sql="INSERT INTO departamento (nombre,descripcion,fechacreada,idusuario,estado) VALUES ('$nombre','$descripcion','$fechacreada','$idusuario','1')";
...
public function desactivar($iddepartamento){
	$sql="UPDATE departamento SET estado='0' WHERE iddepartamento='$iddepartamento'";
	return ejecutarConsulta($sql);
}
public function activar($iddepartamento){
	$sql="UPDATE departamento SET estado='1' WHERE iddepartamento='$iddepartamento'";
	return ejecutarConsulta($sql);
}
