...
public function listar(){
	$sql="SELECT a.idasistencia,a.codigo_persona,a.fecha_hora,a.entrada,a.iniciob,a.finalb,a.salida,a.fecha,u.nombre,u.apellidos,d.nombre as departamento FROM asistencia a INNER JOIN usuarios u INNER JOIN departamento d ON u.iddepartamento=d.iddepartamento WHERE a.codigo_persona=u.codigo_persona";
