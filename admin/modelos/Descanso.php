...
public function listar(){
	$sql="SELECT a.codigo_persona,a.fecha_hora,a.tipo,u.nombre,u.apellidos,u.estado,d.nombre as departamento FROM asistencia a INNER JOIN usuarios u INNER JOIN departamento d ON u.iddepartamento=d.iddepartamento WHERE a.codigo_persona=u.codigo_persona";
	return ejecutarConsulta($sql);
}
